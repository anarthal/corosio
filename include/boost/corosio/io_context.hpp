...
public:
    ...
    */
    bool stopped() const noexcept { return sched_.stopped(); }
    ...
    */
    std::size_t run_one() { return sched_.run_one(); }
    ...
    */
    ...
    std::size_t run_until(std::chrono::time_point<Clock, Duration> const& abs_time)
    {
        std::size_t n = 0;
    ...
    */
    template<class Clock, class Duration>
    std::size_t run_one_until(std::chrono::time_point<Clock, Duration> const& abs_time)
    {
        ...
        while(now < abs_time)
        {
            ...
            std::size_t s = sched_.wait_one(static_cast<long>(
    ...
    /** Process all ready work items without blocking.
        ...
        @return The number of handlers executed.
    */
    std::size_t poll() { return sched_.poll(); }
    ...
    /** Process at most one ready work item without blocking.
        ...
        @return The number of handlers executed (0 or 1).
    */
    std::size_t poll_one() { return sched_.poll_one(); }
...
public:
    ...
    */
    bool running_in_this_thread() const noexcept { return ctx_->sched_.running_in_this_thread(); }

    /** Informs the executor that work is beginning.

        Must be paired with `on_work_finished()`.
    */
    void on_work_started() const noexcept { ctx_->sched_.on_work_started(); }
    ...
    */
    void on_work_finished() const noexcept { ctx_->sched_.on_work_finished(); }
    ...
    */
    void post(capy::coro h) const { ctx_->sched_.post(h); }
    ...
    */
    bool operator==(executor_type const& other) const noexcept { return ctx_ == other.ctx_; }
...
inline auto io_context::get_executor() const noexcept -> executor_type
{
